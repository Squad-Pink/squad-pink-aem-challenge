...
/**
 * Defines the {@code basicContainerModel} Sling Model used for the multifield in {@code reactapp/components/basic-form} component.
 * 
 */
@ConsumerType
public interface basicContainerModel
