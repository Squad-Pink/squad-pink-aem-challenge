...
/**
 * Defines the {@code CertificatesContainer} Sling Model used for the {@code reactapp/components/certificates-container} component.
 * 
 */
@ConsumerType
public interface CertificatesContainer
    extends ComponentExporter
{


    List<certificatesContainerModel> getCertificatesContainer();

    List<dataCertificatesContainerModel> getDataCertificatesContainer();
