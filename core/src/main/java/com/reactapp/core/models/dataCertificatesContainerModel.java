...
/**
 * Defines the {@code dataCertificatesContainerModel} Sling Model used for the multifield in {@code reactapp/components/certificates-container} component.
 * 
 */
@ConsumerType
public interface dataCertificatesContainerModel
